...
INSERT INTO `Applicants` (`Applicants_ID`, `first_name`, `last_name`, `email`, `jobID`, `useroremployee`) VALUES
(1, 'Rachel', 'Ferrara', '', 0, ''),
(2, 'sally', 'smith', '', 0, ''),
(3, 'john', 'smith ', '', 0, ''),
(4, '', '', '', 0, ''),
